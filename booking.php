        ...
        <div class="container">
            ...
            <form action="#" class="book">
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Aaditya Thapa" class="input-responsive" required>

                    <div class="book-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 9843xxxxxx" class="input-responsive" required>

                    <div class="book-label">Email</div>
                    <input type="email" name="email" placeholder="E.g. hi@adityathapa.com" class="input-responsive" required>
